...
#Ne2 = 2
#Ng1 = 0 # 0 # Osc-1, number of guard states
#Ng2 = 0 # 0 # Osc-2, number of guard states
Ne1 = 5 # essential energy levels per oscillator 
Ne2 = 5
Ng1 = 0 # 0 # Osc-1, number of guard states
Ng2 = 0 # 0 # Osc-2, number of guard states
...
bmax = 0.025 # max amplitude ctrl func for Hamiltonian #2
maxpar = [amax, bmax]
