...
inch = 96
fig = CairoMakie.Figure(size=(6.25inch, 2.0inch), fontsize=11, figure_padding=(0.05inch,0.00inch,0.05inch,0.000inch))
...
Label(fig[0, 2:3], "Time Evolution of State Populations", halign = :center, valign = :bottom, fontsize = 11, font = Makie.theme(:fonts).bold)
...
Legend(fig[1,4], ax3, orientation = :vertical, tellwidth = true, framevisible=false)

rowgap!(fig.layout, 1, 0.05inch)
