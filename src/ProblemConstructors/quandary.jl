...
"""
Construct the loweing operators for each subsystem of a larger system.
"""
...
function multi_qubit_system(subsystem_sizes::AbstractVector{Int},
        base_transition_frequency, base_self_kerr, base_cross_kerr; perturbation_ratio=0.1)
