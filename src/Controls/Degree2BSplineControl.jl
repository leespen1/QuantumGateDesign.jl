...
"""
struct Degree2BSplineControl <: AbstractControl
    ...
    dtknot::Float64
    function Degree2BSplineControl(D1, tf)
        D1 = convert(Int64, D1)
...
function Base.copy(control::Degree2BSplineControl)
    return Degree2BSplineControl(control.tf, control.D1)
end


function eval_p_derivative(
        control::Degree2BSplineControl, t::Real, pcof::AbstractVector{<: Real},
...
function eval_grad_p_derivative!(
        grad::AbstractVector{<: Real}, control::Degree2BSplineControl, t::Real,
