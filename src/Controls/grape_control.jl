...
function eval_p(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    i = find_region_index(t, control.tf, control.N_amplitudes)
    return pcof[i]
end

function eval_q(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    i = control.N_amplitudes + find_region_index(t, control.tf, control.N_amplitudes)
    return pcof[i]
end

function eval_pt(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    return 0.0
end

function eval_qt(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    return 0.0
end

function eval_grad_p(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
...
function eval_grad_q(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    grad = zeros(control.N_coeff)
    i = find_region_index(t, control.tf, control.N_amplitudes)
...
function eval_grad_pt(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    grad = zeros(control.N_coeff)
    return grad
end

function eval_grad_qt(control::GRAPEControl, t::Float64, pcof::AbstractVector{Float64})
    grad = zeros(control.N_coeff)
    return grad
end
